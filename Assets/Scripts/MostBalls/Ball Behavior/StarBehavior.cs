...
public class StarBehavior : MonoBehaviour
{
    ...
    void SetNewDestination()
    {
        ...
        //if (transform.position.x >= 719.0f && transform.position.x <= 728.0f) //One that worked better

        //if (transform.position.x >= 717.0f && transform.position.x <= 725.0f)
        if (transform.position.x >= 695.0f && transform.position.x <= 702.0f)
        {
        ...
        //else if (transform.position.x >= 804.0f && transform.position.x <= 825.0f) //One that worked better

        //else if (transform.position.x >= 810.0f && transform.position.x <= 818.0f)
        else if (transform.position.x >= 832.0f && transform.position.x <= 840.0f)
        {
